...
public sealed partial class ResourceSiphonComponent : Component
{
    ...
    [DataField] public float DrainRate = 50f; // Omu, was 10, but that was too slow.
    ...
    [DataField] public float MaxSignalRange = 1000f; // Omu, was 100, but since they can move while draining now, this should be higher.
}
