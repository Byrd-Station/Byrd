...
public sealed partial class ShadowkinLightDetectionDamageComponent : Component
{
    /// <summary>
    /// Max Detection Value
    /// </summary>
    ...
    /// <summary>
    ///  For shadowkin (Light Resistance)
    /// </summary>
    [DataField, AutoNetworkedField]
    ...
    /// Shadowkin will have Light Resistance, so this will get affected by that.
    /// </summary>
    [DataField]
    ...
    [DataField]
    public ProtoId<AlertPrototype> AlertProto = "ShadowkinLight";
